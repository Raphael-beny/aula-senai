...
public class TecnicoService {
	...
	public Tecnico inserir(
		...
		Tecnico tecnicoSalvo = tecnicosRepository.save(novoTecnico);	
		return tecnicoSalvo;				
	}
	...
	public Tecnico alterar(
		...
		Tecnico tecnicoAtualizado = tecnicosRepository.save(tecnicoSalvo);
	...
	public List<Tecnico> listarPor(
			...
			String nome){
		return tecnicosRepository.listarPor("%" + nome + "%");		
	}
	...
	public void removerPor(
			...
			Integer id) {
		tecnicosRepository.deletarPor(id);
	}
